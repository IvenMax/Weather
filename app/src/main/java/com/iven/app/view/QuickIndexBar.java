...
public class QuickIndexBar extends View {
    ...
    public QuickIndexBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        fontSize = a.getDimension(R.styleable.QuickIndexBar_font_size, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, defaultfontSize, getContext().getResources().getDisplayMetrics()));
        a.recycle();
